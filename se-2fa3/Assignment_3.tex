...
\be
  ...
  \be
    ...
    $\ForallApp u, v \in \Sigma^* \mdot \mname{between}(u, v) = aa \land \mname{suc}(v)=\emptyset \land \mname{pred}(u)=\emptyset$
    
    \item $\set{uavbw \mid u,v,w \in \Sigma^*}$.\\
    $\ForallApp u, v, w \in \Sigma^* \mdot \mname{between}(u, v) = a \land \mname{between}(v, w) = b \land \mname{suc}(w)=\emptyset \land \mname{pred}(u)=\emptyset$
